...
- [ ] : 사용자로부터 당첨번호를 입력받습니다.(쉼표를 기준으로 6개의 숫자를 입력받게 합니다.)
- [ ] : 사용자로부터 보너스 번호를 입력받습니다. 

2. 로또 발행 기능
- [ ] : 구입 금액에 해당하는 수량의 로또를 발행한다. (로또 한 장의 가격은 1,000원) 
- [ ] : 1 ~ 45 까지의 숫자중에서 6개의 중복되지 않는 숫자가 포함된 로또를 발행합니다.
- [ ] : 발행된 로또 번호는 오름차순으로 정렬하여 보여줘야 합니다.
...
- [ ] : 각 등수에 해당하는 당첨 개수도 함께 출력해야 합니다.

5. 수익률 계산 및 출력 기능
- [ ] : 총 수익률을 계산하여 소수점 둘째 자리까지 반올림한 값을 출력합니다.
  - [ ] : 수익률은 ((당첨금액/ 구입금액) * 100) 으로 계산됩니다.
...
- [ ] : 로또 번호는 1~45 사이의 정수여야 하며, 중복이 없어야 합니다.

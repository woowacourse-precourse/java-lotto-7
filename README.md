...
- [ ] 로또 구입 금액
	- [ ] 구입 금액은 1,000의 배수이어야 한다.
	- [ ] 구입 금액은 최소 1,000원 이상이어야 한다.
- [ ] 당첨 번호
	- [ ] 당첨 번호는 6개의 겹치지 않은 숫자로 이루어진다.
	- [ ] 각 번호는 1~45 사이의 값을 가진다.
- [ ] 보너스 번호
	- [ ] 보너스 번호는 1개의 숫자로 이루어진다.
	- [ ] 번호는 1~45 사이의 값을 가진다.

**✅ 도메인 테스트**

- [ ] 로또 구매
	- [ ] 로또 구매 개수는 `구입 금액 / 1000`이다.
- [ ] 로또 번호 생성
	- [ ] 로또 번호는 6개의 겹치지 않은 숫자로 이루어진다.
	- [ ] 각 번호는 1~45 사이의 값을 가진다.
- [ ] 로또 당첨 결과 확인
	- [ ] 당첨 번호가 3개 미만으로 일치하면, 꽝이다.
	- [ ] 당첨 번호가 3개 일치하면, 5등이다.
	- [ ] 당첨 번호가 4개 일치하면, 4등이다.
	- [ ] 당첨 번호가 5개 일치하고 보너스 번호가 일치하지 않으면, 3등이다.
	- [ ] 당첨 번호가 5개 일치하고 보너스 번호가 일치하면, 2등이다.
	- [ ] 당첨 번호가 6개 일치하면, 1등이다.

**✅ 출력 테스트**

- [ ] 구입한 로또 번호 출력
	- [ ] 구입 가격에 올바른 개수의 로또를 출력한다.
	- [ ] 올바른 출력 형식을 따른다. (e.g. [1, 2, 3, 4, 5, 6])
- [ ] 로또 결과 출력
	- [ ] 5등부터 1등까지 차례대로 당첨 수를 출력한다.
- [ ] 수익률 출력
	- [ ] 결과에 따라 `총 수익 / 구입 금액`을 출력한다.
...
- [ ] 기존 클래스의 역할을 더욱 작게 쪼개는 것을 고려한다.
- [ ] 일급 컬렉션을 적극적으로 활용한다.
- [ ] 메서드의 이름을 더욱 명확히 할 수 있도록 노력한다.
	- 메서드의 이름의 길이는 최대한 15 이하가 되도록 한다.
...
`amp.nextstep.edu.missionutils`에서 제공하는 Console을 활용한다.

- [ ] 로또 구입 금액을 입력받고, 도메인 제약사항에 부합하는지 검증한다.
- [ ] 로또 당첨 번호를 입력받고, 도메인 제약사항에 부합하는지 검증한다.
- [ ] 로또 보너스 번호를 입력받고, 도메인 제약사항에 부합하는지 검증한다.

**✅ 로또를 생성한다.**

- [ ] 구입 가격에 맞는 로또 개수를 생성한다.
	- Random 값 추출은 `camp.nextstep.edu.missionutils.Randoms`의 `pickUniqueNumbersInRange()`를 활용한다.
- [ ] 생성된 로또 번호가 도메인 제약사항에 부합한 지 검증한다.
- [ ] 생성된 로또 번호를 출력한다.

**✅ 로또 결과를 확인한다.**

- [ ] 당첨 번호와 보너스 번호를 토대로, 로또의 등수를 반환한다.
- [ ] 등수 별로 당첨된 개수를 출력한다.
- [ ] 구입 금액 대비 수익률을 출력한다.

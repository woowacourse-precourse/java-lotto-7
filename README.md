...
- 구입 금액 입력 시
  - 구입 금액이 숫자가 아닌 경우
  - 1등 당첨 금액보다 큰 액수를 입력했을 경우
  - Integer형으로 변경이 불가능한 경우
  - 1000원 단위로 나누어 떨어지지 않을 경우
- 로또 구매 시
  - 구매 가능한 로또 수량을 초과한 경우
  - 로또 번호가 6개가 아닌 경우
  - 로또 번호가 오름차순 정렬되지 않은 경우
  - 로또 번호가 중복될 경우
- 당첨 번호 입력 시
  - 6개의 숫자와 쉼표로 이루어진 문자열이 아닌 경우
  - 당첨 번호가 1부터 45사이의 숫자가 아닌 경우
- 보너스 번호 입력 시
  - 숫자 문자열이 아닌 경우
  - 보너스 번호가 1부터 45사이의 숫자가 아닌 경우
  - 당첨 번호와 중복될 경우

...
* `2024-10-29` 프로젝트 구조 설정 및 조건 내용 숙지
* `2024-10-29` README.md 최초 작성

* `2024-10-30` 입력 관련 기능 구현 및 테스트 구현

* `2024-10-31` 로또 번호 생성 기능 구현

* `2024-11-01` 출력 기능 구현

* `2024-11-02` 예외처리 및 테스트 코드 구현 

* `2024-11-03` 최종 검토 및 수정

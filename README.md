...
- 로또 당첨 판단
   ...
   - [ ] 일치하는 번호의 수 합산
      - [ ] 6개가 일치할 경우 1등의 개수를 1 증가시킨다. 
      - [ ] 5개가 일치할 경우, 보너스 번호가 일치하면 2등의 개수를 1 증가시킨다. 
      - [ ] 5개가 일치할 경우, 보너스 번호가 일치하지 않으면 3등의 개수를 1 증가시킨다.
      - [ ] 4개가 일치할 경우 4등의 개수를 1 증가시킨다. 
      - [ ] 3개가 일치할 경우 5등의 개수를 1 증가시킨다. 
- 로또 당첨금 계산

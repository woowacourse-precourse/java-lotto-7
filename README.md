...
## 개발 진행사항
### 입력
-[ ] 구입 금액을 입력 받고, 1,000으로 나눈 값만큼 실행
  -[ ] 구입 금액이 1,000미만일시 에러 발생
  -[ ] 구입 금액을 입력받지 못할 시 에러 발생
-[ ] 당첨 금액을 ", "로 구분하여 입력 받습니다. (Lotto 클래스)
  - [ ] 중복 존재시 입력 에러 발생
  - [ ] 번호가 6회 미만으로 입력받을 시 에러 발생
  - [ ] 번호가 입력받지 않을 시 에러 발생
  - [ ] 번호가 1~45범위 밖일시 에러 발생
- [ ] 보너스 번호를 입력 받습니다. 
  - [ ] 입력을 받지 않을시 에러 발생
  - [ ] 번호가 1~45 범위 밖일기 에러 발생
  - [ ] 당첨 번호와 중복시 에러 발생
### 출력
- [ ] 상수만 저장하는 함수

...
- 왜 발생하는가?
  ...
  - 인생사 새옹지마 
  - 이게 재앙이 될지 복이 될지 감히 어찌 아리오.. 
  - 그저 묵묵히 할 뿐
  - 뜨거운 열정보다 묵묵한 걸음이 더 좋다
- 현재 진행상황 파악 위해 ./gradlew clean test -> 실패하는 테스트 13개 확인
...
- [x] 토요일 0700 to 2030 아르바이트 후 저녁 1시간 확보 가능
  ...
  - [x]  너무 개발을 하고 싶지만 친구들도 나라는 주체와 함께 성장하는 팀원이고 신뢰는 중요하기에 져버리진 않아야 한다
  -   - [x] 친구 집 일찍 도착했으나 친구 트러블있어서 친구 트러블슈팅..
  - 번아웃인가 15시부터 21시 40분까지 앉아있어도 코딩이 안되는.. 왜 이러지 몸이 아 왜 이러고살지나는
  - 무슨 부귀영화를 누리자고..
  - 죽고싶다 왜 죽지도 못하지
  - 살고싶지 않다
  - 마음이 허전하고 공허하다 나는 분명 남들보다 많은 돈을 벌었는데 돈 내놓으라는 소리에 시달렸고
  - 의미를 찾으며 지내다 코딩을 독학했는데 이젠 그거대로 힘든일이 생기고 별.. 그냥 내가 나약한건지 뭔지
  - 에혀 개발이나해야지
  - 내가 참 수고가 많다 ㅋ
  ...
  - [x] 2317 1시간 코딩 종료 내일 안전운전을 위해 숙면 -> 느낀점) 제약이 창의성을 만든다

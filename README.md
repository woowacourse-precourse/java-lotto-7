...
1. 로또 구입 금액 검증
  1. 구입 금액이 빈 값인 경우
  2. 구입 금액이 음수인 경우
  3. 구입 금액이 1000원 단위가 아닌경우
    - 문제 요구사항이었음: 구입 금액은 1,000원 단위로 입력 받으며 1,000원으로 나누어 떨어지지 않는 경우 예외 처리한다.
  4. 구입 금액이 숫자가 아닌경우
2. 당첨 번호 검증
  1. 빈값이거나 6개가 아닌경우
  2. 1 ~ 45의 숫자가 아닌경우
  3. 중복된 숫자가 포함된 경우
3. 보너스 번호 검증
  1. 보너스 번호가 1 ~ 45 사이의 숫자가 아닌경우
  2. 보너스 번호가 당첨 번호와 중복된 경우
4. 로또 번호 생성 시 검증
  1. 로또 번호는 6개 아닌경우
  2. 로또 번호가 1 ~ 45 사이의 숫자가 아닌경우
  3. 로또 번호에 중복된 숫자가 포함된 경우

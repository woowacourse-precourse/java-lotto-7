...
### 로또 구입 금액을 입력할 때 규칙
- 1000원 단위로 입력 가능합니다.
    - 1000원 이상 10,000,000이하로 입력 가능합니다.
...
> ❌ 불가능한 구입 금액: `800`,`이천원`,`1000+4000`,`0`, `2,000`,` 1000 `, `100000000`
...
- 유효성 검사(구매 금액)
  ...
  - 0 입력 제한
  - 빈 입력 제한
  - 현재 최대 구매 금액은 10,000,000으로 한다.   
  -> 테스트 결과 1000원부터 10,000,000원까지 구매 금액으로 입력했을 경우 실행 시간이 1초 미만으로 비슷하나,
    100,000,000을 입력했을 경우 실행 시간이 1초 이상 걸렸기 때문에 최대 구매 금액은 10,000,000으로 정한다.

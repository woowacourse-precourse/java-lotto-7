...
# 기능 요구 조건
1. money 를 반환  (최대 금액은 10만원이다) 
2. 로또 머신을 (여기에 money 객체 가 들어감) 사용하여 로또티켓을 구매한다
3. 당첨 번호를 입력한다
4. 보너스 번호를 입력한다 이때 당첨번호랑 중복된 값이 있는지 확인해야함
...
1. Money
   ...
   - [x] 숫자가 아닌 값을 입력할 경우
2. BonusNumber
   - [x] 1 ~ 45까지 범위의 숫자가 아닌경우
   - [x] WinningLotto 랑 중복된 값이 있는 경우
# 기능 테스트
- [x] 당첨에 따른 금액 테스트
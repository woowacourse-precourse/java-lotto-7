...
1. [x] 구입 금액 입력
   ...
   - [x] 1000원 미만이나 100000원 초과할 시 예외처리
   - [x] 유효한 값 입력되지 않을 시 예외처리(빈 값, 문자열)
2. [x] 예외처리 시 1번(구입 금액 입력)으로 돌아감
3. [x] 구입금액만큼 6개 당첨번호가 담긴 로또 객체 생성
   - [x] 오름차순 정렬
4. [x] 구매한 로또 번호 출력
5. [x] 당첨 번호 입력
   - [x] 문자 입력 시 예외처리
   - [x] 중복 값 입력 시 예외처리
   - [x] 1~45 이외 번호 입력 시 예외처리
   - [x] 6개 미만이나 초과 입력 시 예외처리
   - [x] 구분자가 쉼표가 아닐 시 예외처리
6. [x] 예외처리 시 5번(당첨 번호 입력)으로 돌아감
7. [x] 보너스 번호 입력
   - [x] 문자 입력 시 예외처리
   - [x] 빈 값 입력 시 예외처리
   - [x] 1~45 이외 번호 입력 시 예외처리
   - [x] 당첨 번호와 중복될 시 예외처리
8. [x] 예외처리 시 7번(보너스 번호 입력)으로 돌아감
9. [x] 로또 당첨 번호가 담긴 객체 생성
10. [x] 당첨 번호와 로또 번호 비교
   - [x] 3개 이상 일치 시 당첨 통계 객체에 갯수 추가
11. [x] 당첨 통계 출력
12. [x] 수익률 계산
13. [x] 수익률 출력

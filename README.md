...
- [ ] **로또 구입 금액 입력 받기**
    ...
    - [ ] 입력 금액이 1,000원으로 나누어 떨어지지 않으면 `[ERROR]` 메시지를 출력하고 다시 입력 받기

- [ ] **로또 번호 생성 및 발행**
    - [ ] 입력된 금액에 따라 발행할 로또 수량 계산
    - [ ] 로또 번호 범위(1~45) 내에서 중복되지 않는 6개의 번호 생성
    - [ ] 생성된 로또 번호를 오름차순으로 정렬
    - [ ] 발행된 로또 수량과 각각의 로또 번호를 출력

- [ ] **당첨 번호와 보너스 번호 입력 받기**
    - [ ] 당첨 번호 6개를 쉼표(,)로 구분하여 입력 받기
    - [ ] 입력된 번호들이 1~45 범위 내의 숫자이며, 중복이 없는지 확인
    - [ ] 보너스 번호를 입력 받기
    - [ ] 보너스 번호가 1~45 범위 내의 숫자이며, 당첨 번호와 중복되지 않는지 확인
    - [ ] 입력값이 유효하지 않을 경우 `[ERROR]` 메시지를 출력하고 다시 입력 받기

- [ ] **로또 당첨 확인**
    - [ ] 사용자가 구매한 각 로또 번호와 당첨 번호를 비교

...
- [x] 로또 번호 발행 : 구매 횟수 만큼의 랜덤 로또 번호를 발행하고 로또 별로 보관합니다
- [x] 당첨 번호 설정 : 사용자로부터 입력받은 당첨 번호 및 보너스 번호를 이용하여 설정합니다
- [x] 당첨 비교 : 랜덤한 로또 번호와 당첨 번호를 비교하여 일치 숫자를 확인하고 당첨 일치 수량을 확인합니다
- [x] 수익률 계산 : 사용자가 구매한 로또 비용과 최종 당첨 금액 총합을 비교하여 수익률을 계산합니다
- [x] 결과 출력 : 랜덤하게 발행된 로또 번호들과 최종 당첨 통계를 출력합니다

---

## 사용 방법
사용자 화면에 아래와 같이 최초 안내 메시지가 보여진다.
<pre><code> 구입금액을 입력해 주세요. </code></pre>

이후 2번째 입력 안내 메시지가 보여진다.
<pre><code> 당첨 번호를 입력해 주세요. 
 보너스 번호를 입력해 주세요.</code></pre>

### 사용자 입력 방법
- 구입 금액
  - 사용자는 1000원 단위에 최소 1000부터 100_000원까지 입력이 가능합니다.
  - 입력 시 로또는 자동으로 발행되며, 발행한 로또는 화면에서 확인이 가능합니다.
- 당첨번호
  - 당첨 번호는 띄어쓰기 없이 ,를 이용하여 구분하여 입력합니다.
  - 총 6개의 1이상 45이하의 양의 정수를 입력합니다.
  - <pre><code>ex) 1,2,3,4,5,6</code></pre>
- 보너스번호
  - 보너스 번호는 1이상 45이하의 한자리 양의 정수를 입력합니다.

...
- [ ] 구매한 로또 갯수 만큼 로또 번호를 출력한다.
- [ ] 당첨 번호를 입력 받는다. 번호는 쉼포(,)를 기준으로 구분한다.
- [ ] 보너스 번호를 입력 받는다.
- [ ] 당첨 통계 출력.
...
- [ ] 로또 구입 금액 입력 시 정수가 아닌 값을 입력할 경우.
- [ ] 로또 구입 금액이 1,000원으로 나누어 떨어지지 않는 경우.
- [ ] 당첨 번호 6개를 제대로 입력하지 않았을 경우.
    - [ ] 갯수에 맞춰 제대로 입력하지 않았을 경우.
    - [ ] 1~45사이의 정수를 입력하지 않았을 경우.
- [ ] 보너스 번호를 입력하지 않았을 경우.

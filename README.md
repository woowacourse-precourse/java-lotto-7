...
flowchart TD
    ...
    B --> C[issueLottoTickets]
    C --> D[LottoPurchaseAmount]
    D --> E[LottoQuantityManager]
    E --> F[LottoNumberGenerator]
    F --> G[Lotties]
    G --> H[LottoNumberPrinter]
    B --> I[issueLotteryResult]
    I --> J[LottoWinningNumber]
    J --> K[LottoBonusNumber]
    K --> L[LotteryResultManager]
    L --> M[LottoTotalResult]
    M --> N[LottoTotalReturnManager]

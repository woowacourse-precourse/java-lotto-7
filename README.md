...
1. 1~45 사이의 랜덤한 숫자를 6번 뽑는다.
  - 중복된 숫자는 없어야 한다.
  - 오름차순으로 정렬하여 저장한다.
  - EXCEPTION 1~45 사이의 숫자가 아니면 예외. 6개의 숫자가 아니면 예외.
2. 로또 구입 가격을 입력한다.
  - 로또 1장당 1000원이다.
  - 로또 구입 가격만큼 최대한 로또를 구매해야 한다.
  - EXCEPTION 천원 단위가 아니면 예외. 숫자가 아닌 값이면 예외.

**[로또 추첨]**
1. 1~45 사이의 랜덤한 숫자를 6번 뽑는다. + 보너스 숫자를 1개 더 뽑는다.
  - 중복된 숫자는 없어야 한다.
  - EXCEPTION 1~45 사이의 숫자가 아니면 예외. 7개의 숫자가 아니면 예외.
...
3. 수익률을 계산한다.
  - 소수점 둘째 자리에서 반올림한다.
  - EXCEPTION 반드시 소수점 첫째 자리도 출력해야 함.

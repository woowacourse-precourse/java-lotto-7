...
- [X] 로또 번호가 1~45에서 범위가 벗어나는 경우
- [X] 뽑은 로또 번호가 6개가 아닌 경우
- [X] 중복 로또 번호가 존재하는 경우
- [X] 입력한 당첨번호가 6개가 아닌 경우
- [X] 입력한 당첨번호가 쉼표로 구분되지 않는 경우
- [X] 입력한 당첨번호들 중 1~45에서 범위가 벗어나는 숫자가 있는 경우
- [X] 입력한 당첨번호에 숫자가 아닌 문자가 포함된 경우

...
public class ErrorMessages {
    public static final String NULL_INPUT = "[ERROR] 입력은 null 일 수 없습니다.";

    public static final String EMPTY_INPUT = "[ERROR] 입력은 빈 문자열 일 수 없습니다.";

    public static final String WHITESPACE_ONLY = "[ERROR] 입력은 공백으로만 구성될 수 없습니다.";

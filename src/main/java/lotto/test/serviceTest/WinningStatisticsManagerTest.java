...
public class WinningStatisticsManagerTest {
    ...
    public void testIncreaseThree() {
        ...
        WinningNumberChecker checker = new WinningNumberChecker();
        checker.setWinningNumber(List.of(1,2,3,7,8,9));
    ...
    public void testIncreaseFour() {
        Lotto lotto = new Lotto(List.of(1,2,3,4,5,6));
        WinningNumberChecker checker = new WinningNumberChecker();
        checker.setWinningNumber(List.of(1,2,3,4,8,9));
    ...
    public void testIncreaseFive() {
        Lotto lotto = new Lotto(List.of(1,2,3,4,5,6));
        WinningNumberChecker checker = new WinningNumberChecker();
        checker.setWinningNumber(List.of(1,2,3,4,5,7));
        checker.setBonusNumber(8);
    ...
    public void testIncreaseFiveAndBonus() {
        Lotto lotto = new Lotto(List.of(1,2,3,4,5,6));
        WinningNumberChecker checker = new WinningNumberChecker();
        checker.setWinningNumber(List.of(1,2,3,4,5,9));
        checker.setBonusNumber(6);
    ...
    public void testIncreaseSix() {
        Lotto lotto = new Lotto(List.of(1,2,3,4,5,6));
        WinningNumberChecker checker = new WinningNumberChecker();
        checker.setWinningNumber(List.of(1,2,3,4,5,6));

...
public enum LottoRank {
    FIRST_RANK(6, 2000000000, "6개 일치 (2,000,000,000원) - "),
    SECOND_RANK(5, 30000000, "5개 일치, 보너스 볼 일치 (30,000,000원) - "),
    THIRD_RANK(5, 1500000, "5개 일치 (1,500,000원) - "),
    FOURTH_RANK(4, 50000, "4개 일치 (50,000원) - "),
    FIFTH_RANK(3, 5000, "3개 일치 (5,000원) - "),
    OTHER_RANK(0, 0, "");

...
public class OutputViewConstants {
    public static final String PURCHASE_AMOUNT_DESCRIPTION = "개를 구매했습니다.";
    public static final String FIFTH_PRIZE = "3개 일치 (5,000원) - ";
    public static final String FOURTH_PRIZE = "4개 일치 (50,000원) - ";
    public static final String THIRD_PRIZE = "5개 일치 (1,500,000원) - ";

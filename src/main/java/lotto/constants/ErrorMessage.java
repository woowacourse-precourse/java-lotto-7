...
public enum ErrorMessage {
    ...
    ONLY_DIGITS_ALLOWED_AMOUNTS("로또 금액은 오직 숫자만 입력할 수 있습니다. 다시 입력해주세요."),
    ONLY_INTEGER_RANGE_AMOUNTS_ALLOWED("로또 금액은 정수만 입력될 수 있습니다. 다시 입력해주세요."),
    ...
    ONLY_INTEGER_BONUS_NUMBER_ALLOWED("보너스 번호는 정수값만 입력할 수 있습니다."),

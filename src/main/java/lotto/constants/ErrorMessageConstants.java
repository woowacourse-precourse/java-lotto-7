...
public class ErrorMessageConstants {
    ...
    public static final String EMPTY_WINNING_NUMBERS = ERROR_PREFIX + "당첨 번호는 공백일 수 없습니다.";
    public static final String INVALID_WINNING_NUMBER_FORMAT = ERROR_PREFIX + "당첨 번호는 숫자로 입력해야 합니다.";
    public static final String INVALID_WINNING_NUMBER_COUNT = ERROR_PREFIX + "당첨 번호는 6개를 입력해야 합니다.";
    public static final String INVALID_WINNING_NUMBER_RANGE = ERROR_PREFIX + "당첨 번호는 1부터 45 사이의 숫자를 입력해야 합니다.";
    public static final String INVALID_WINNING_NUMBER_DUPLICATE = ERROR_PREFIX + "당첨 번호는 중복될 수 없습니다.";

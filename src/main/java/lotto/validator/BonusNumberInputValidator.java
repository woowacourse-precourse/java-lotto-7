...
public class BonusNumberInputValidator implements BasicValidator<String> {
    ...
    private static final String INPUT_IS_NOT_NUMERIC = "[ERROR] 입력값이 숫자가 아닙니다.";
    private static final String INPUT_IS_NOT_BETWEEN_ONE_AND_FORTY_FIVE = "[ERROR] 입력값이 1과 45 사이여야 합니다.";
    ...
    private void isBetweenOneAndFortyFive(String input) {
        ...
        if (bonusNumber < MIN_LOTTO_NUMBER || bonusNumber > MAX_LOTTO_NUMBER) {
            throw new IllegalArgumentException(INPUT_IS_NOT_BETWEEN_ONE_AND_FORTY_FIVE);
        }
    }
}
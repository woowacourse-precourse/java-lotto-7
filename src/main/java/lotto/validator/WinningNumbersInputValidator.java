...
public class WinningNumbersInputValidator {
    ...
    private static void validateAllNumbersIfNumeric(String input) {
    ...
    private static void validateInputNumbersCount(String input) {
        String[] numbers = input.split(COMMA);
    ...
    private static void validateDuplicatedNumber(String input) {
        String[] numbers = input.split(COMMA);

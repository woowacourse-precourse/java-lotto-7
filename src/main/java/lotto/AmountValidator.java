...
public class AmountValidator {
    ...
    private static final String MAXIMUM_AMOUNT_ERROR = "[ERROR] 로또 구입 금액은 1,000,000원 이하여야 합니다.";
    ...
    public void validateAmount(int lottoAmount) {
        ...
        if (lottoAmount > 1000000) {
            throw new IllegalArgumentException(MAXIMUM_AMOUNT_ERROR);
        }

...
public class Application {
    public static void main(String[] args) {
        int purchaseAmount = getPurchaseAmount(); // 총 구매 금액 계산
        int n = purchaseAmount / 1000;  // 구매할 로또 개수
        ...
        // 당첨 결과 계산 및 수익률 출력
        JudgeWinLotto.calculateResults(purchasedLottos, winningNumbers, bonusNumber, purchaseAmount);
    }

    private static int getPurchaseAmount() {
        while (true) {
            try {
                return Amount.inputBuyPrice() * 1000;

...
public class Application {
    ...
    public static void main(String[] args) {
        LottoTicketQuantity lottoTicketQuantity
                = new LottoTicketQuantity(Validator.isValidPurchaseAmount(InputView.getPurchaseAmount()));
        ...
        lottos.addLottos(Validator.isValidWinningNumber(InputView.getWinningNumber()));

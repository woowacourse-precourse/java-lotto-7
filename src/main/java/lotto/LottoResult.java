...
public class LottoResult {
    ...
    public LottoResult(){
        ...
        winningStatistics.put(CorrectStatus.FIVE_CORRECT_WITH_NO_BONUS_NUMBER,DEFAULT_COUNT);
        winningStatistics.put(CorrectStatus.FIVE_CORRECT_WITH_BONUS_NUMBER,DEFAULT_COUNT);
    ...
    private  CorrectStatus getCorrectStatus(final WinningLottoNumberSelector winningLottoNumberSelector,
        ...
        boolean containSpecialNumber = winningLottoNumberSelector.containBonusNumber(purchasedLotto);
        CorrectStatus correctStatus = findByMatchCountAndBonusNumber(matchNumber,containSpecialNumber);

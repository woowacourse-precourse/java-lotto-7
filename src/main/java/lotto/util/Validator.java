...
public class Validator {
    ...
    public void isBonusNumberValid(String bonusNumber) {
        ...
        }else if(Integer.parseInt(bonusNumber) < Constants.RANDOM_MIN_NUM && Integer.parseInt(bonusNumber) > Constants.RANDOM_MAX_NUM) {
    ...
    public void isLottoNumberValid(String lottoNumber) {
        ...
        }else if(Integer.parseInt(lottoNumber) < Constants.RANDOM_MIN_NUM && Integer.parseInt(lottoNumber) > Constants.RANDOM_MAX_NUM) {
    ...
    public void isLottoNumbersValid(List<Integer> lottoNumbers) {
        ...
        }else if(lottoNumbers.size() > Constants.LOTTO_NUMBER_COUNT) {

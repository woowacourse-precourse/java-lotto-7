...
public class ErrorMessage {
    // Money 관련 에러 메시지
    public static final String MINIMUM_PURCHASE_AMOUNT = "[ERROR] 로또 구매는 1000원부터 가능합니다.";
    public static final String INVALID_PURCHASE_UNIT = "[ERROR] 로또 구매는 1000원 단위로 가능합니다";

    // 입력 검증 관련 에러 메시지
    public static final String EMPTY_INPUT = "[ERROR] 입력값이 없습니다.";
    public static final String INVALID_NUMBER_FORMAT = "[ERROR] 유효한 숫자 형식이 아닙니다.";
    public static final String NEGATIVE_NUMBER = "[ERROR] 금액은 음수가 될 수 없습니다.";
    public static final String COMMA_SEPARATED_NUMBER = "[ERROR] 쉼표(,)로 구분된 숫자만 입력 가능합니다.";

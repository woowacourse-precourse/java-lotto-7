...
public class ErrorMessages {
    ...
    public static final String BONUS_NUMBER_DUPLICATION = "[ERROR] 보너스 번호는 당첨 번호와 중복될 수 없습니다.";
    public static final String INVALID_LOTTO_PRICE = "[ERROR] 구입 금액은 1,000원 단위로 입력해 주세요.";

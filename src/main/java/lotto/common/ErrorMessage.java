...
public class ErrorMessage {
    ...
    public static final String NOT_POSITIVE_PAYMENT ="[ERROR] 금액은 양의 정수이어야 합니다";
    public static final String NOT_UNIT_PAYMENT = "[ERROR] 금액은 1000 단위이어야 합니다";
    public static final String INVALID_PAYMENT_TYPE="[ERROR] 금액은 숫자만 입력할 수 있으며 숫자는 정수 범위이어야 합니다";

    public static final String INVALID_WINNING_INPUT_TYPE ="[ERROR] 쉼표와 숫자만 입력할 수 있으며 숫자는 정수 범위이어야 합니다" ;
    public static final String INVALID_WINNING_COUNT = "[ERROR] 당첨 번호는 여섯개여야 합니다.";
    public static final String INVALID_WINNING_RANGE = "[ERROR] 당첨 번호는 1부터 45 사이의 숫자여야 합니다";
    public static final String DUPLICATED_WINNING_NUMBER = "[ERROR] 당첨 번호는 서로 다른 숫자여야 합니다.";
    public static final String INVALID_START_END_POINT = "[ERROR] 당첨 번호 입력의 시작 또는 끝은 쉼표일 수 없습니다";

    public static final String DUPLICATED_BONUS_NUMBER ="[ERROR] 보너스 번호는 당첨 번호와 달라야 합니다" ;

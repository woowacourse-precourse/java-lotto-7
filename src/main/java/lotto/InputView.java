...
public class InputView {
    ...
    public static final int MAXIMUM_AMOUNT = 2147000000; // int 타입 범위 내 최대 구입 금액 설정
    ...
    private static void validateAmount(int amount) {
        ...
        if (amount > MAXIMUM_AMOUNT) {
            throw new IllegalArgumentException("[ERROR] 구입 금액이 너무 큽니다. 최대 2,147,000,000원까지 가능합니다.");
        }
        if (amount % 1000 != 0) {

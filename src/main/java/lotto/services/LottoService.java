...
public class LottoService implements LottoServices {
    ...
    public LottoStatistic createLottoStatistics() {
    ...
    public void checkLottoYield(LottoStatistics lottoStatistic, int amount) {
        lottoStatistic.updateLottoYield(amount);
    }

...
public class OutputView {
    ...
    public static void printResult(List<Integer> rankCount, double earningsRate) {
        ...
        for (int i = 0; i < rankCount.size(); i++) {
            ...
            if (i == 1) {
                String second = "5개 일치, 보너스 볼 일치 (30,000,000원) - %d개".formatted(rankCount.get(i));
                System.out.println(second);
            }
            if (i == 2) {
                String third = "5개 일치 (1,500,000원) - %d개".formatted(rankCount.get(i));
                System.out.println(third);
            }
            if (i == 3) {
                String fourth = "4개 일치 (50,000원) - %d개".formatted(rankCount.get(i));
                System.out.println(fourth);
            }
            if (i == 4) {
                String fifth = "3개 일치 (5,000원) - %d개".formatted(rankCount.get(i));

...
public class OutputView {
    ...
    public void printCreateLottoInfo(GeneratedLottoInfo generatedLottoInfo) {
        System.out.println();
        System.out.println(getPurchaseMessageFormat(generatedLottoInfo.totalGeneratedLottos()));
        System.out.println(generatedLottoInfo.generatedLottoNumbers());
    }

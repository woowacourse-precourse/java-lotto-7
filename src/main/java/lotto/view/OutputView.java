...
public class OutputView {
    ...
    public static void LottoResultOutcome(LottoResultsTracker lottoResultsTracker) {
        ...
        System.out.println("---");
        System.out.println("3개 일치 (5,000원) - " + lottoResultsTracker.getRankCount(LottoRank.FOURTH)+ "개");
        ...
        System.out.println("5개 일치, 보너스 볼 일치 (30,000,000원) - " +  lottoResultsTracker.getRankCount(LottoRank.SECOND)+ "개");

...
public class OutputView {
    ...
    public void showLottos(final Lottos lottos) {
        System.out.println();
    ...
    public void showResult(final LottoOutputDto lottoOutputDto) {
        System.out.println();
    ...
    private void showWinningDetails(final LottoResult lottoResult) {

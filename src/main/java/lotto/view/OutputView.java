...
public class OutputView {
    ...
    public static void printCorrect(int[] count){
        System.out.println("3개 일치 (5,000원) - "+count[TREEE_CORRECT]);
        System.out.println("4개 일치 (50,000원) - "+count[FOUR_CORRECT]);
        System.out.println("5개 일치 (1,500,000원) - "+count[FIVE_CORRECT]);
        System.out.println("5개 일치, 보너스 볼 일치 (30,000,000원) - "+count[FIVE_AND_BONUS_CORRECT]);
        System.out.println("6개 일치 (2,000,000,000원) - "+count[SIX_CORRECT]);
    }

...
public enum LottoMessageFormats {
    ...
    OUTPUT_PURCHASED_COUNT_MESSAGE(LINE_BREAK.message + "%d개를 구매했습니다."),
    OUTPUT_WINNING_STATISTICS_HEADER(LINE_BREAK.message + "당첨 통계" + LINE_BREAK.message + "---"),
    OUTPUT_BONUS_RESULT_FORMAT("%d개 일치, 보너스 볼 일치 (%s원) - %d개"),
    OUTPUT_MATCH_RESULT_FORMAT("%d개 일치 (%s원) - %d개"),
    OUTPUT_RETURN_RATE_MESSAGE_FORMAT("총 수익률은 %.1f%%입니다."),
    OUTPUT_PRIZE_FORMAT("#,###");

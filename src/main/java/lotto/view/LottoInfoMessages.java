...
public enum LottoInfoMessages {
    ...
    INSERT_MANUAL_NUMBERS_START("""
            수동으로 구매할 1~45 사이의 겹치지 않는 6개의 번호를 쉼표로 구분해 입력해주세요.
            (수동 구매 갯수가 [\s"""),
    INSERT_MANUAL_NUMBERS_END(" ]개 남았습니다. Enter를 누르면 자동으로 번호를 입력합니다.)"),
    TOTAL_BUY_AMOUNT("[구입 번호 목록]"),

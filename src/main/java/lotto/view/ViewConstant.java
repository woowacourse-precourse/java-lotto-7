...
public class ViewConstant {
    ...
    public static final String INPUT_WINNING_NUMBER_PROMPT = "당첨 번호를 입력해 주세요.";
    public static final String INPUT_BONUS_NUMBER_PROMPT = "보너스 번호를 입력해 주세요.";
    ...
    public static final String PRIZE_FORMAT = " (%s원) - %d개%n";
}

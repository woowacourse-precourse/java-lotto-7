...
public class InputView {
    ...
    private final static Pattern POSITIVE_NUMBER_ONLY_PATTERN = Pattern.compile("[1-9]\\d*");
    ...
    private final static String NUMBER_INPUT_EXCEPTION_MESSAGE = "양수를 입력하셔야 합니다";
    ...
    private void validateNumber(String input) {
        if (!POSITIVE_NUMBER_ONLY_PATTERN.matcher(input).matches()) {

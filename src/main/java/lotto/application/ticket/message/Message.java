...
public class Message {
    ...
    public static final String NEED_MORE_MONEY = "[ERROR] 구매 가능한 금액이 부족합니다.";

    public static final String CANT_NULL_ID = "[ERROR] 티켓 ID는 null일 수 없습니다.";
    public static final String CANT_NULL_LOTTO = "[ERROR] 로또 목록은 null일 수 없습니다.";
    public static final String CANT_EMPTY_LOTTO = "[ERROR] 로또 목록은 비어있을 수 없습니다.";

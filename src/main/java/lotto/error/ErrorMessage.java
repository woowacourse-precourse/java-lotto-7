...
public class ErrorMessage {
    ...
    public static final String EXCEEDED_NUMBER_RANGE = String.format("번호는 %d부터 %d 사이의 자연수여야 합니다.", MIN_NUMBER,
            MAX_NUMBER);
    public static final String INVALID_WINNING_NUMBER_SIZE = String.format("당첨 번호는 %d자리여야 합니다.", WINNING_NUMBER_SIZE);
    public static final String INVALID_NUMBER_FORMAT = String.format("숫자는 %,d를 넘지 않는 자연수만 가능합니다.",
            Integer.MAX_VALUE);

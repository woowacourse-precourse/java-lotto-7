...
public class LottoException {
    ...
    private static final String MESSAGE_LOTTO_ASCENDING = "[ERROR] 로또 안의 번호들은 오름차순으로 정렬되어야 합니다.";
    ...
    public static void exceptionLottoAscending() {
        throw new IllegalArgumentException(MESSAGE_LOTTO_ASCENDING);
    }

...
public enum ErrorMessage {
    ...
    OUT_RANGE_LOTTO_NUMBER("[ERROR] 로또 번호는 1부터 45 사이의 숫자여야 합니다."),
    DUPLICATED_LOTTO_NUMBER("[ERROR] 로또 번호는 중복되지 않아야 합니다."),
    BLANK_BONUS_NUMBER("[ERROR] 보너스 번호를 입력하지 않았습니다."),
    TOO_BIG_BONUS_NUMBER("[ERROR] 로또 번호가 너무 큽니다."),
    NOT_NUMERIC_BONUS_NUMBER("[ERROR] 보너스 번호는 숫자여야 합니다."),
    OUT_RANGE_BONUS_NUMBER("[ERROR] 보너스 번호는 1부터 45 사이의 숫자여야 합니다."),

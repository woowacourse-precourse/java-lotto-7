...
public enum ErrorMessage {
    ...
    WINNING_NUMBER_OUT_OF_RANGE(format("로또 번호는 %d부터 %d 사이의 숫자여야 합니다.", MIN_LOTTO_NUMBER.getValue(), MAX_LOTTO_NUMBER.getValue())),
    ...
    BONUS_NUMBER_OUT_OF_RANGE(format("보너스 번호는 %d부터 %d 사이의 숫자여야 합니다.", MIN_LOTTO_NUMBER.getValue(), MAX_LOTTO_NUMBER.getValue()));

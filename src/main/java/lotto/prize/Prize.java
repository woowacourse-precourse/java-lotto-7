...
public enum Prize {
    ...
    THIRD((match, bonus) -> match == 5 && bonus, 1500000, "6개 일치 (1,500,000원) - %d개"),
    FOURTH((match, bonus) -> match == 4, 50000, "6개 일치 (50,000원) - %d개"),
    FIFTH((match, bonus) -> match == 3, 5000, "6개 일치 (5,000원) - %d개"),

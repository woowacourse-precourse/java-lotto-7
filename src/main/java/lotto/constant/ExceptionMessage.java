...
public class ExceptionMessage {
    ...
    //input
    public static final String NOT_NUMBER_ERROR = "[ERROR] 숫자를 입력해주세요";
    public static final String MAX_AMOUNT_ERROR = "[ERROR] 1-10억 이내의 금액만 입력할 수 있습니다";
    ...
    public static final String INVALID_NUMBER_FORMAT_ERROR = "[ERROR] 1-45사이의 숫자를 입력해 주세요";

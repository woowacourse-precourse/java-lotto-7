...
public enum ErrorMessage {
    ...
    INVALID_LOTTO_NUMBER_SIZE("[ERROR] 로또 번호의 개수가 6개여야 합니다."),
    DUPLICATION_LOTTO_NUMBER("[ERROR] 로또 번호에 중복이 없어야 합니다." ),
    INVALID_PURCHASE_AMOUNT("[ERROR] 구입 금액이 1000원 단위여야 합니다.");

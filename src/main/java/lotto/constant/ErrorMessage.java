...
public class ErrorMessage {
    ...
    public static String PURCHASE_AMOUNT_DIVISIBILITY_ERROR_MESSAGE =
            ERROR_PREFIX + "로또 구입 금액은 1000원으로 나누어 떨어져야 합니다." + ERROR_SUFFIX;
    public static String BONUS_NUMBER_DUPLICATE_WITH_WINNING_ERROR_MESSAGE =
            ERROR_PREFIX + "보너스 번호는 담청 번호와 중복되면 안됩니다." + ERROR_SUFFIX;
    public static String WINNING_NUMBER_FORMAT_ERROR_MESSAGE =
            ERROR_PREFIX + "당첨 번호는 숫자만 가능합니다. 입력 형식을 확인해 주세요" + ERROR_SUFFIX;
    public static String PURCHASE_AMOUNT_POSITIVE_INTEGER_ERROR_MESSAGE =
            ERROR_PREFIX + "구입 금액은 양의 정수여야 합니다." + ERROR_SUFFIX;

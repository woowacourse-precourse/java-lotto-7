...
public class ErrorMessageConstants {
    ...
    public static final String NEGATIVE_NUMBER = MESSAGE_START + "0 이하의 수는 입력할 수 없습니다.";
    public static final String OUT_NUMBER_RANGE = MESSAGE_START + "1 ~ 45 사이의 숫자만 입력할 수 있습니다.";

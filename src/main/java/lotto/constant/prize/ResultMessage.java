...
public class ResultMessage {
    ...
    public static final String SECOND_PRIZE = "5개 일치, 보너스 볼 일치 (30,000,000원) - %d개";
    public static final String FIRST_PRIZE = "6개 일치 (2,000,000,000원) - %d개";
    public static final String NON_PRIZE = "";

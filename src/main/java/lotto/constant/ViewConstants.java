...
public enum ViewConstants {
    ...
    SEPARATE_LINE("---"),
    FIFTH_HIT_MESSAGE("3개 일치 (5,000원) - "),
    FOURTH_HIT_MESSAGE("4개 일치 (50,000원) - "),
    THIRD_HIT_MESSAGE("5개 일치 (1,500,000원) - "),
    SECOND_HIT_MESSAGE("5개 일치, 보너스 볼 일치 (30,000,000원) - "),
    FIRST_HIT_MESSAGE("6개 일치 (2,000,000,000원) - "),
    COUNT_MESSAGE("개");

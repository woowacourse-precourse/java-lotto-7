...
public enum OutputMessage {
    ...
    public String getFormatWinningStatisticMessage(int correctCount, int bonusCount, int winningCount){
        return String.format(message, correctCount, bonusCount, winningCount);
    }

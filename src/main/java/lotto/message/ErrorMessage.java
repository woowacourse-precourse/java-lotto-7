...
public enum ErrorMessage {
    ...
    INVALID_NATURAL_AMOUNT("[ERROR] 로또 구매 금액은 자연수여야 합니다."),
    INVALID_THOUSAND_AMOUNT("[ERROR] 로또 구매 금액은 1000원 단위만 가능합니다."),
    INVALID_WRONG_DELIMITER("[ERROR] 숫자와 , 만 입력값으로 받을 수 있습니다.");

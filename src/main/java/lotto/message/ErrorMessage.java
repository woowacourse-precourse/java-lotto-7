...
public enum ErrorMessage {
    ...
    LOTTO_SIZE_ERROR("로또 번호는 {}개여야 합니다."),
    LOTTO_NUMBERS_DUPLICATE("{}개의 로또 번호는 중복될 수 없습니다."),
    NON_INTEGER_LOTTO("로또 번호는 정수여야 합니다."),
    LOTTO_SCOPE_ERROR("로또 번호는 1 이상 45 이하의 정수여야 합니다."),
    BONUS_NUMBER_DUPLICATE("보너스 번호는 {}개의 당첨 번호와 중복될 수 없습니다.");
...
//        String priceFormat = String.valueOf(value).replaceAll("_", ",");

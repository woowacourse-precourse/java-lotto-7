...
public enum InputErrorMessage {
    ...
    NULL_WINNING_NUMBER("[ERROR] 당첨 번호를 null 값으로 둘 수 없습니다."),
    NON_NUMERIC_WINNING_NUMBER("[ERROR] 당첨 번호는 숫자여야 합니다."),
    NON_NUMERIC_BONUS_NUMBER("[ERROR] 보너스 번호는 숫자여야 합니다."),
    INVALID_BONUS_NUMBER_RANGE("[ERROR] 보너스 번호는 1부터 45 사이의 숫자여야 합니다."),
    INVALID_BONUS_NUMBER_COUNT("[ERROR] 보너스 번호는 당첨 번호와 중복 입력이 불가능합니다.");

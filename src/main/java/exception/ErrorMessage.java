...
public enum ErrorMessage {
    ...
    NOT_NUMBER_FORMAT("숫자로 입력해야 합니다."),
    DUPLICATE_WINNING_NUMBERS("당첨 번호는 중복되지 않는 숫자여야 합니다."),
    NOT_SIX_WINNING_NUMBERS("당첨 번호는 6자리여야 합니다."),
    BONUS_NUMBER_IN_WINNING_NUMBERS("보너스 번호는 당첨 번호에 포함될 수 없습니다."),

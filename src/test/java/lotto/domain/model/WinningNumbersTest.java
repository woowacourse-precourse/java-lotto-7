...
public class WinningNumbersTest {
    @Test
    @DisplayName("빈 문자열을 입력할 경우 NullPointerException이 발생한다.")
    void 빈_문자열을_입력할_경우_NullPointerException이_발생한다() {
        // given
        String emptyNumbers = "";
    ...
    @Test
    @DisplayName("당첨 번호가 6개가 아닐 경우 IllegalArgumentException이 발생한다.")
    ...
    @Test
    @DisplayName("당첨 번호에 중복된 숫자가 있을 경우 IllegalArgumentException이 발생한다.")
    ...
    @Test
    @DisplayName("당첨 번호 범위가 벗어날 경우 IllegalArgumentException이 발생한다.")
    ...
    @Test
    @DisplayName("입력된 문자열에 숫자 외에 문자가 있을 경우 IllegalArgumentException이 발생한다.")

...
class NumbersTest {
    ...
    void 정상_범위의_숫자들을_생성해_본다() {
        ...
        Numbers numbers = Numbers.createNumbers(validNumbers);

        assertThat(numbers).isEqualTo(Numbers.createNumbers(validNumbers));
    }
    ...
    void 정상_범위를_벗어난_숫자들로_Numbers를_생성하면_예외가_발생한다() {
        ...
        Assertions.assertThatThrownBy(() -> Numbers.createNumbers(invalidNumbers))

...
class LottoTicketsTest {
    ...
    void 로또들의_리스트를_가지고_있는_컬렉션_생성() {
        ...
        final Lotto lottoEx2 = new Lotto(List.of(11, 12, 13, 14, 15, 16));
        final Lotto lottoEx3 = new Lotto(List.of(21, 22, 23, 24, 25, 26));

        // when
        final LottoTickets tickets = new LottoTickets(List.of(lottoEx1, lottoEx2, lottoEx3));

        // then
        assertThat(tickets.tickets().size()).isEqualTo(3);
    }
}
...
public class BonusNumberTest {
    // 보너스 번호 엔티티 ( BonusNumber.java ) 테스트

    @DisplayName("[BonusNumberTest] 보너스 번호에 빈 값이 입력되면 예외가 발생한다")
    @ParameterizedTest
    @NullSource
    ...
    @DisplayName("[BonusNumberTest] 보너스 번호에 숫자 외의 값이 입력되면 예외가 발생한다")
    @ParameterizedTest
    ...
    @DisplayName("[BonusNumberTest] 보너스 번호가 1 과 45 사이의 숫자가 아니면 예외가 발생한다")
    @ParameterizedTest

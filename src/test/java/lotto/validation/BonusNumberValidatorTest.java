...
class BonusNumberValidatorTest {
    ...
    void 보너스_번호_범위_검증_테스트(int invalidBonusNumber) {
        assertThatThrownBy(() -> BonusNumberValidator.validateBonusNumber(VALID_WINNING_NUMBERS, invalidBonusNumber))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void 보너스_번호_중복_검증_테스트() {
        assertThatThrownBy(() -> BonusNumberValidator.validateBonusNumber(VALID_WINNING_NUMBERS, DUPLICATE_BONUS_NUMBER))
                .isInstanceOf(IllegalArgumentException.class)

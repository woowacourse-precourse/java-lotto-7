...
class ValidationTest {
    ...
    void 당첨_번호의_개수가_6개가_아닌_경우_예외가_발생한다() {
        assertThatThrownBy(() -> Validation.validateLotto(List.of(1, 2, 3, 4, 5)))
    ...
    void 당첨_번호_중_중복된_숫자가_있는_경우_예외가_발생한다() {
        assertThatThrownBy(() -> Validation.validateLotto(List.of(1, 2, 3, 4, 5, 5)))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void 당첨_번호의_숫자들이_1부터_45_사이의_숫자가_아닌_경우_예외가_발생한다() {
        assertThatThrownBy(() -> Validation.validateLotto(List.of(0, 2, 3, 4, 5, 6)))
                .isInstanceOf(IllegalArgumentException.class)

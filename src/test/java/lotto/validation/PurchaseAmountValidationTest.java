...
class PurchaseAmountValidationTest {
    ...
    public void 구입_금액_1000원_단위() {
        assertThatThrownBy(() -> PurchaseAmountValidation.purchaseAmountValidation(1200))
    ...
    public void 구입_금액_성공_테스트(String purchaseAmount) {
        ...
        assertThat(PurchaseAmountValidation.purchaseAmountValidationAndGetLottoQuantity(purchaseAmount)).isEqualTo(expectedAmount);
    }

...
class WinnerServiceTest {
    ...
    void announceWinner() {
        ...
        Assertions.assertEquals(LottoWinning.FOUR_MATCH.getCount(), 1);
        Assertions.assertEquals(LottoWinning.FIVE_MATCH.getCount(), 0);
        Assertions.assertEquals(LottoWinning.FIVE_MATCH_WITH_BONUS_NUMBER.getCount(), 0);

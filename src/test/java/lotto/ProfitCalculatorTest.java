...
public class ProfitCalculatorTest {
    ...
    void 맞힌개수_초기화() {
        ...
        matchedCount.put(MatchedCountKeyEnum.THREE_MATCHED.getMessage(), 0);
        matchedCount.put(MatchedCountKeyEnum.FOUR_MATCHED.getMessage(), 0);
        matchedCount.put(MatchedCountKeyEnum.FIVE_MATCHED.getMessage(), 0);
        matchedCount.put(MatchedCountKeyEnum.FIVE_WITH_BONUS_MATCHED.getMessage(), 0);
        matchedCount.put(MatchedCountKeyEnum.SIX_MATCHED.getMessage(), 0);
    }

    @Test
    void 지원페이지_예제_케이스() {
        matchedCount.put(MatchedCountKeyEnum.THREE_MATCHED.getMessage(), 1);
        assertThat(ProfitCalculator.calculate(8000, matchedCount)).isEqualTo("62.5");
    }

    @Test
    void 하나의_1등이_당첨됐을_경우() {
        matchedCount.put(MatchedCountKeyEnum.SIX_MATCHED.getMessage(), 1);
        assertThat(ProfitCalculator.calculate(5000, matchedCount)).isEqualTo("40,000,000.0");
    }

    @Test
    void 하나의_2등이_당첨됐을_경우() {
        matchedCount.put(MatchedCountKeyEnum.FIVE_WITH_BONUS_MATCHED.getMessage(), 1);
        assertThat(ProfitCalculator.calculate(5000, matchedCount)).isEqualTo("600,000.0");
    }

    @Test
    void 하나의_3등이_당첨됐을_경우() {
        matchedCount.put(MatchedCountKeyEnum.FIVE_MATCHED.getMessage(), 1);
        assertThat(ProfitCalculator.calculate(5000, matchedCount)).isEqualTo("30,000.0");
    }

    @Test
    void 하나의_4등이_당첨됐을_경우() {
        matchedCount.put(MatchedCountKeyEnum.FOUR_MATCHED.getMessage(), 1);
    ...
    @Test
    void 여러_개의_경우_5() {
        matchedCount.put(MatchedCountKeyEnum.THREE_MATCHED.getMessage(), 47998);
        matchedCount.put(MatchedCountKeyEnum.FOUR_MATCHED.getMessage(), 2891);
        matchedCount.put(MatchedCountKeyEnum.FIVE_MATCHED.getMessage(), 59);
        matchedCount.put(MatchedCountKeyEnum.FIVE_WITH_BONUS_MATCHED.getMessage(), 2);
        matchedCount.put(MatchedCountKeyEnum.SIX_MATCHED.getMessage(), 1);

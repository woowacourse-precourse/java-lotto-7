...
class ApplicationTest extends NsTest {
    ...
    @Test
    void 기능_테스트_1등_당첨된_경우() {
        assertRandomUniqueNumbersInRangeTest(
                () -> {
                    run("8000", "3,5,11,16,32,38", "44");
                    assertThat(output()).contains(
                            "8개를 구매했습니다.",
                            "[8, 21, 23, 41, 42, 43]",
                            "[3, 5, 11, 16, 32, 38]",
    ...
    @Test
    void 기능_테스트_2등_당첨된_경우() {
        assertRandomUniqueNumbersInRangeTest(
                () -> {
                    run("8000", "3,5,11,16,32,44", "38");
                    assertThat(output()).contains(
                            "8개를 구매했습니다.",
                            "[8, 21, 23, 41, 42, 43]",
                            "[3, 5, 11, 16, 32, 38]",
    ...
    @Test
    void 기능_테스트_3등_당첨된_경우() {
        assertRandomUniqueNumbersInRangeTest(
                () -> {
                    run("8000", "3,5,11,16,32,44", "42");
                    assertThat(output()).contains(
                            "8개를 구매했습니다.",
                            "[8, 21, 23, 41, 42, 43]",
                            "[3, 5, 11, 16, 32, 38]",
    ...
    @Test
    void 기능_테스트_4등_당첨된_경우() {
        assertRandomUniqueNumbersInRangeTest(
                () -> {
                    run("8000", "3,5,11,16,33,45", "41");
                    assertThat(output()).contains(
                            "8개를 구매했습니다.",
                            "[8, 21, 23, 41, 42, 43]",
                            "[3, 5, 11, 16, 32, 38]",
    ...
    @Test
    void 기능_테스트_5등_당첨된_경우() {
        assertRandomUniqueNumbersInRangeTest(
                () -> {
                    run("8000", "3,5,11,19,33,45", "41");
                    assertThat(output()).contains(
                            "8개를 구매했습니다.",
                            "[8, 21, 23, 41, 42, 43]",
                            "[3, 5, 11, 16, 32, 38]",

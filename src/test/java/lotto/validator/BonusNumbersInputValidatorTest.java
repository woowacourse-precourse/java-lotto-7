...
public class BonusNumbersInputValidatorTest {
    ...
    void throwsExceptionOutOfRange() {
        assertThrows(IllegalArgumentException.class, () -> InputValidator.validateBonusNumber("46", List.of(1, 2, 3, 4, 5, 6)),
    ...
    void throwsExceptionIsDuplicate() {
        assertThrows(IllegalArgumentException.class, () -> InputValidator.validateBonusNumber("1", List.of(1, 2, 3, 4, 5, 6)),

...
class WinningNumbersInputValidatorTest {
    ...
    void throwsExceptionNumbersAreBlank() {
        assertThrows(IllegalArgumentException.class, () -> InputValidator.validateWinningNumbers(List.of("", " ")),
                "[ERROR] 값을 입력해주세요.");
    }
    ...
    void throwsExceptionNumbersAreNotPositive(String number) {
        assertThrows(IllegalArgumentException.class, () -> InputValidator.validateWinningNumbers(List.of(number)),
                "[ERROR] 양의 정수를 입력해주세요.");
    }
    ...
    void throwsExceptionNotSixNumbers() {
        ...
        assertThrows(IllegalArgumentException.class, () -> InputValidator.validateWinningNumbers(numbers),

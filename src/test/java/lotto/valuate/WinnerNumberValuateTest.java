...
class WinnerNumberValuateTest {

    @Test
    void isValidNumber_validNumber_doesNotThrowException() {
        String validInput = "15";

        assertDoesNotThrow(() -> WinnerNumberValuate.isValidNumber(validInput),
    ...
    void isValidNumber_blankInput_throwsException() {
        ...
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                () -> WinnerNumberValuate.isValidNumber(blankInput),
    ...
    void isValidNumber_nonNumericInput_throwsException() {
        ...
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                () -> WinnerNumberValuate.isValidNumber(nonNumericInput),

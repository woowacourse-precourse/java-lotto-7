...
public class ValidatorTest {
    ...
    void divisibleByThousand() {
        ...
        moneyInfo.forEach((money) -> verifyException(money, ErrorMessage.DIVISIBLE_BY_THOUSAND));
    }
    @Test
    ...
    void validateAmountUnderLimit() {
        ...
        amountLimit.forEach((amount) -> verifyException(amount, ErrorMessage.AMOUNT_LIMIT));
    }
    private void verifyException(String input, ErrorMessage errorMessage) {
        assertThatThrownBy(
                () -> Won.of(input))

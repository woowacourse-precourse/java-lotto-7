...
class LottoResultTest {
    ...
    void 로또_결과_조정() {
        ...
        WinningLottoNumberSelector winningLottoNumberSelector = new WinningLottoNumberSelector(
                new WinningNumber(Lotto.createWinningRegularLotto("1,2,3,4,5,6"),new BonusNumber("7")),
        ...
        assertThat(resultAfterAdjust.winningStatistics.get(CorrectStatus.FIVE_CORRECT_WITH_NO_BONUS_NUMBER)).isEqualTo(1);
        assertThat(resultAfterAdjust.winningStatistics.get(CorrectStatus.FIVE_CORRECT_WITH_BONUS_NUMBER)).isEqualTo(0);
    ...
    void 로또_수익_계산() {
        ...
        //then
        Assertions.assertThat(profit).isEqualTo(CorrectStatus.SIX_CORRECT.getReward()+CorrectStatus.FIVE_CORRECT_WITH_NO_BONUS_NUMBER.getReward());

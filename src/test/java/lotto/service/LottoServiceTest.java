...
class LottoServiceTest {
    ...
    public void 구입_금액_예외_테스트(String moneyInput) {
        Assertions.assertThatThrownBy(() -> lottoService.purchaseLotto(moneyInput))
    ...
    public void 로또_예외_테스트(String winningNumbersInput) {
        Assertions.assertThatThrownBy(() -> lottoService.setWinningLotto(winningNumbersInput))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageContaining(LottoTestConstant.ERROR_MESSAGE_HEADER.getMessage());
    }
    ...
    public void 보너스_숫자_예외_테스트(String bonusNumberInput) {
        Assertions.assertThatThrownBy(() -> lottoService.setBonusNumber(bonusNumberInput))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageContaining(LottoTestConstant.ERROR_MESSAGE_HEADER.getMessage());
    }
}
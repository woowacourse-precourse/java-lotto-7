...
class InputValidatorTest {
    ...
    void shouldThrowException_whenInputIsEmpty() {
        Exception exception = assertThrows(IllegalArgumentException.class, () ->
                InputValidator.validateStringTypeAmount(""));
    ...
    void shouldThrowException_whenInputContainsWhitespace() {
        Exception exception = assertThrows(IllegalArgumentException.class, () ->
                InputValidator.validateStringTypeAmount("1, 000"));
    ...
    void shouldThrowException_whenInputContainsInvalidCharacters() {
        Exception exception = assertThrows(IllegalArgumentException.class, () ->
                InputValidator.validateStringTypeAmount("1,000a"));
    ...
    void shouldThrowException_whenAmountIsBelowMinimum() {
        Exception exception = assertThrows(IllegalArgumentException.class, () ->
                InputValidator.validateIntegerTypeAmount(500));
    ...
    void shouldThrowException_whenAmountExceedsLimit() {
        Exception exception = assertThrows(IllegalArgumentException.class, () ->
                InputValidator.validateIntegerTypeAmount(100050));
    ...
    void shouldThrowException_whenAmountNotDivisibleByThousand() {
        Exception exception = assertThrows(IllegalArgumentException.class, () ->
                InputValidator.validateIntegerTypeAmount(1050));
    ...
    void shouldPassValidation_whenInputIsValid() {
        assertDoesNotThrow(() -> {
            InputValidator.validateStringTypeAmount("10,000");
            InputValidator.validateIntegerTypeAmount(10000);
        });
    }

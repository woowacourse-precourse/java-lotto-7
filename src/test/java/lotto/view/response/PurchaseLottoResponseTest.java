...
public class PurchaseLottoResponseTest {
    ...
    static Stream<Arguments> 로또_일급_컬렉션_객체로부터_생성된다_테스트_케이스() {
        return Stream.of(
                makeArguments(Lottos.generate(3, realRandomNumberGenerator)),
                makeArguments(Lottos.generate(6, realRandomNumberGenerator)),
                makeArguments(Lottos.generate(10, realRandomNumberGenerator))
        );
    }

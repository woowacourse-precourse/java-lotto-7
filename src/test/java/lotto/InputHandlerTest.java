...
public class InputHandlerTest {
    ...
    void 입력된_구입_금액이_1000_단위가_아닌_경우_예외가_발생한다() {
        assertThatThrownBy(() -> new InputHandler.readPurchaseAmount("1001")
    ...
    void 입력된_구입_금액이_1000_미만인_경우_예외가_발생한다() {
        assertThatThrownBy(() -> new InputHandler.readPurchaseAmount("990")
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void 입력_중_숫자가_아닌_다른_값이_들어올_경우_예외가_발생한다() {
        assertThatThrownBy(() -> new InputHandler.readPurchaseAmount("1000ab")
                .isInstanceOf(IllegalArgumentException.class);
    }
}

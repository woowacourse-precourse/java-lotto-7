...
public class LottoNumbersInputParserTest {
    ...
    class SuccessCases {
        ...
        public void 유효한_입력으로_로또_번호를_반환한다(String input) {
            List<Integer> result = LottoNumbersInputParser.parseLottoNumbers(input);
    ...
    class FailureCases {
        ...
        public void null_입력값에_예외를_발생시킨다() {
            assertThatExceptionOfType(CustomIllegalArgumentException.class)
                    .isThrownBy(() -> LottoNumbersInputParser.parseLottoNumbers(null))
        ...
        public void 빈_문자열_입력값에_예외를_발생시킨다() {
            assertThatExceptionOfType(CustomIllegalArgumentException.class)
                    .isThrownBy(() -> LottoNumbersInputParser.parseLottoNumbers(""))
        ...
        public void 빈_항목이_포함된_입력에_예외를_발생시킨다(String input) {
            assertThatExceptionOfType(CustomIllegalArgumentException.class)
                    .isThrownBy(() -> LottoNumbersInputParser.parseLottoNumbers(input))

...
class ParserTest {
    ...
    void joinWithDelimiterTest() {
        ...
        List<LottoTicket> tickets = List.of(
                LottoTicket.ofLottoNumbers(List.of(LottoNumber.of(1), LottoNumber.of(2), LottoNumber.of(3), LottoNumber.of(4), LottoNumber.of(5), LottoNumber.of(6))),
                LottoTicket.ofLottoNumbers(List.of(LottoNumber.of(7), LottoNumber.of(8), LottoNumber.of(9), LottoNumber.of(10), LottoNumber.of(11), LottoNumber.of(12)))
        );
        String delimiter = ";";
